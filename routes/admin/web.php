...
Route::group(['prefix'=>'admins','namespace'=>'Admins','middleware'=>['auth','rights']], function () {
    ...
    // 友情链接管理
    Route::get('/links/index', 'Links@index');   // 链接列表
    Route::get('/links/edit', 'Links@edit');   // 编辑链接
    Route::post('/links/save', 'Links@save');   // 保存链接
    Route::post('/links/delete', 'Links@delete');   // 删除链接

...
<body>
  <div class="layui-fluid" id="register_container">
    <div id="register_box">
        <form class="layui-form" method="POST" id="register_form" action="/doregister">
          @csrf
          <div class="layui-form-item">
            <label class="layui-form-label">账号</label>
            <div class="layui-input-block">
              <input type="text" name="username" lay-verify="required" lay-reqtext="请输入账号" placeholder="请输入用户名" class="layui-input">
            </div>
          </div>
          <div class="layui-form-item">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="password" name="password_confirmation" lay-verify="required" lay-reqtext="请确认密码" placeholder="请重新输入密码" class="layui-input">
            </div>
          </div>
          {{-- <div class="layui-form-item">
            <div class="layui-form-item">
